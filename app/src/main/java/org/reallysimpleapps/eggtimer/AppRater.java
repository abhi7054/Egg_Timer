...
public class AppRater {
    ...
    private static final String DEFAULT_TEXT_TITLE = "Hey egg lover!";
    private static final String DEFAULT_TEXT_EXPLANATION = "Now we've helped you boil your perfect egg, PLEASE take a moment to rate us. It would make us super-eggcited :-)";
    private static final String DEFAULT_TEXT_NOW = "Rate now";
    private static final String DEFAULT_TEXT_LATER = "Later";
    private static final String DEFAULT_TEXT_NEVER = "Never ever";
    private static final int DEFAULT_DAYS_BEFORE_PROMPT = 1;
